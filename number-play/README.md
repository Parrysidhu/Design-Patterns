...
I have used HashMap to create filter and observer mapping. The HashMap uses the Hashing technique which converts large String to small String which ultimately helps in indexing faster and searching. HashMap stores unique values. It doesn’t allow duplicate values to be stored.
